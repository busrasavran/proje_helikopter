class Helicopter(SilahlıKuvvetler):
...
#uzunluk fonksiyonuyla helikopterin uzunluğuna(metre cinsinde) ait bilgileri görebiliyoruz.
...
#distance fonksiyonu helikopter toplam kütlesine göre FATO(Son yaklaşma ve kalkış alanı) kenarı ile uçak pisti kenarı veya taksi yolu kenarı arasındaki mesafeyi görebiliyoruz.
...
#Toplam helikopter kütlesine göre olması gereken FATO(Son yaklaşma ve kalkış alanı) kenarı ile uçak pisti kenarı veya taksi yolu kenarı arasındaki mesafeyi görebiliyoruz.
